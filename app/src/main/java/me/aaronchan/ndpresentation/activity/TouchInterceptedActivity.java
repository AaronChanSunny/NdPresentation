...
public class TouchInterceptedActivity extends AppCompatActivity {

    private static final String TAG = TouchInterceptedActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_touch_intercepted);
